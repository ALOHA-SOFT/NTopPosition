package com.aloha.company.service;
...
public class EmailServiceImpl implements EmailService {
    ...
    @Value("${spring.mail.username:admin@엔탑포지션.com}")
    private String fromEmail;
    
    @Value("${app.admin.email:admin@엔탑포지션.com}")
    ...
    public boolean sendFormCompletionEmail(Forms forms) {
        try {
            ...
            helper.setSubject("[엔탑포지션] 설문 작성이 완료되었습니다");
    ...
    public boolean sendFormNotificationEmailToAdmin(Forms forms) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setSubject("[엔탑포지션] 새로운 설문이 접수되었습니다");
